(module
 ...
 (data (i32.const 352) "now=\00")
 (data (i32.const 368) " exp=\00")
 ...
 (func $_ZN5proxy13apply_onerrorIJEEEvyRKN5eosio7onerrorE (param $0 i64) (param $1 i32)
  ...
  (call $_ZN5eosio6unpackINS_11transactionEEET_PKcj
   (get_local $4)
   (tee_local $2
    (i32.load offset=16
     (get_local $1)
 ...
 (func $_ZN5eosio6unpackINS_11transactionEEET_PKcj (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
  (i32.store offset=4
