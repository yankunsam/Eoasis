...
(module
 ...
 (table 0 anyfunc)
 (memory $0 1)
 (data (i32.const 4) "p3\00\00")
 (data (i32.const 16) "getowner\00")
 (data (i32.const 32) "getidentity\00")
 ...
 (data (i32.const 464) "owner\00")
 (data (i32.const 480) "unexpected error in fixed_key constructor\00")
 ...
 (func $apply (param $0 i64) (param $1 i64) (param $2 i64)
  (call $_ZN13identity_test8contract5applyEyyy
   (get_local $0)
   (get_local $1)
   (get_local $2)
  )
 )
 (func $_ZN13identity_test8contract5applyEyyy (param $0 i64) (param $1 i64) (param $2 i64)
  (local $3 i32)
  (local $4 i32)
  (local $5 i64)
  (local $6 i64)
  ...
  (block $label$6
   (block $label$7
    ...
    (i64.store offset=8
     (get_local $9)
     (call $_ZN8identity8contractILy8238557868240928768EE22get_owner_for_identityEyy
      (get_local $0)
      (call $_ZN5eosio18unpack_action_dataIN13identity_test8contract22get_owner_for_identityEEET_v)
     )
    )
    (call $_ZN5eosio9singletonILy8238557868254212496ELy13452719259138392064ELy8238557868254212496EyE3setERKyyy
     (i32.add
      (get_local $9)
      (i32.const 8)
     )
   ...
   (set_local $8
    (call $_ZN5eosio18unpack_action_dataIN13identity_test8contract24get_identity_for_accountEEET_v)
   )
   (i64.store offset=8
    (get_local $9)
    (i64.const 0)
   ...
   (block $label$14
    (br_if $label$14
     (i64.eqz
      (tee_local $5
       (call $_ZN5eosio9singletonILy8238557868240928768ELy3607749778735104000ELy8238557868240928768EyE14get_or_defaultEyRKy
        (get_local $8)
        (i32.add
         (get_local $9)
         (i32.const 8)
 ...
 (func $_ZN5eosio18unpack_action_dataIN13identity_test8contract22get_owner_for_identityEEET_v (result i64)
  (local $0 i32)
  (local $1 i32)
  (local $2 i64)
  (local $3 i32)
 ...
 (func $_ZN8identity8contractILy8238557868240928768EE22get_owner_for_identityEyy (param $0 i64) (param $1 i64) (result i64)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $_ZN5eosio9singletonILy8238557868254212496ELy13452719259138392064ELy8238557868254212496EyE3setERKyyy (param $0 i32) (param $1 i64) (param $2 i64)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  ...
  (block $label$0
   (block $label$1
    (block $label$2
     ...
     (call $eosio_assert
      (i32.eq
       (i32.load offset=8
        (tee_local $4
         (call $_ZNK5eosio11multi_indexILy13452719259138392064ENS_9singletonILy8238557868254212496ELy13452719259138392064ELy8238557868254212496EyE3rowEJEE31load_object_by_primary_iteratorEl
          (i32.add
           (get_local $6)
           (i32.const 24)
          )
     ...
     (call $_ZN5eosio11multi_indexILy13452719259138392064ENS_9singletonILy8238557868254212496ELy13452719259138392064ELy8238557868254212496EyE3rowEJEE6modifyIZNS2_3setERKyyyEUlRS3_E_EEvRKS3_yOT_
      (i32.add
       (get_local $6)
       (i32.const 24)
      )
    ...
    (call $_ZN5eosio11multi_indexILy13452719259138392064ENS_9singletonILy8238557868254212496ELy13452719259138392064ELy8238557868254212496EyE3rowEJEE7emplaceIZNS2_3setERKyyyEUlRS3_E0_EENS4_14const_iteratorEyOT_
     (i32.add
      (get_local $6)
      (i32.const 8)
     )
 ...
 (func $_ZN5eosio18unpack_action_dataIN13identity_test8contract24get_identity_for_accountEEET_v (result i64)
  (local $0 i32)
  (local $1 i32)
  (local $2 i64)
  (local $3 i32)
 ...
 (func $_ZN5eosio9singletonILy8238557868240928768ELy3607749778735104000ELy8238557868240928768EyE14get_or_defaultEyRKy (param $0 i64) (param $1 i32) (result i64)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $_ZNK5eosio11multi_indexILy13452719259138392064ENS_9singletonILy8238557868254212496ELy13452719259138392064ELy8238557868254212496EyE3rowEJEE31load_object_by_primary_iteratorEl (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $_ZN5eosio11multi_indexILy13452719259138392064ENS_9singletonILy8238557868254212496ELy13452719259138392064ELy8238557868254212496EyE3rowEJEE6modifyIZNS2_3setERKyyyEUlRS3_E_EEvRKS3_yOT_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i32)
  (i32.store offset=4
   (i32.const 0)
   (tee_local $4
 ...
 (func $_ZN5eosio11multi_indexILy13452719259138392064ENS_9singletonILy8238557868254212496ELy13452719259138392064ELy8238557868254212496EyE3rowEJEE7emplaceIZNS2_3setERKyyyEUlRS3_E0_EENS4_14const_iteratorEyOT_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $_ZNSt3__16vectorIN5eosio11multi_indexILy13452719259138392064ENS1_9singletonILy8238557868254212496ELy13452719259138392064ELy8238557868254212496EyE3rowEJEE8item_ptrENS_9allocatorIS7_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINS6_4itemENS_14default_deleteISD_EEEERyRlEEEvDpOT_ (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $_ZN5eosio11multi_indexILy4805230851241541632EN8identity8contractILy8238557868240928768EE7certrowEJNS_10indexed_byILy4590200209379688448EN5boost11multi_index13const_mem_funIS4_NS_9fixed_keyILj32EEEXadL_ZNKS4_7get_keyEvEEEEEEEE6modifyIZNS3_22get_owner_for_identityEyyEUlRS4_E_EEvRKS4_yOT_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i64)
  (local $5 i32)
  (local $6 i64)
  (local $7 i32)
 ...
 (func $_ZN5eosio11multi_indexILy4805230851241541632EN8identity8contractILy8238557868240928768EE7certrowEJNS_10indexed_byILy4590200209379688448EN5boost11multi_index13const_mem_funIS4_NS_9fixed_keyILj32EEEXadL_ZNKS4_7get_keyEvEEEEEEEE6modifyIZNS3_22get_owner_for_identityEyyEUlRS4_E0_EEvRKS4_yOT_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i64)
  (local $5 i32)
  (local $6 i64)
  (local $7 i32)
 ...
 (func $_ZNK5boost4hana6detail7on_eachIPZN5eosio11multi_indexILy4805230851241541632EN8identity8contractILy8238557868240928768EE7certrowEJNS3_10indexed_byILy4590200209379688448ENS_11multi_index13const_mem_funIS8_NS3_9fixed_keyILj32EEEXadL_ZNKS8_7get_keyEvEEEEEEEE6modifyIZNS7_22get_owner_for_identityEyyEUlRS8_E0_EEvRKS8_yOT_EUlRSM_E_EclIJRNS0_5tupleIJNS0_9type_implINSG_5indexILy4590200209379688448ESE_Ly0ELb0EEEE1_ENSU_INSV_ILy4590200209379688448ESE_Ly0ELb1EEEE1_EEEEEEEvDpOT_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i64)
 ...
 (func $_ZNK5boost4hana6detail7on_eachIPZN5eosio11multi_indexILy4805230851241541632EN8identity8contractILy8238557868240928768EE7certrowEJNS3_10indexed_byILy4590200209379688448ENS_11multi_index13const_mem_funIS8_NS3_9fixed_keyILj32EEEXadL_ZNKS8_7get_keyEvEEEEEEEE6modifyIZNS7_22get_owner_for_identityEyyEUlRS8_E_EEvRKS8_yOT_EUlRSM_E_EclIJRNS0_5tupleIJNS0_9type_implINSG_5indexILy4590200209379688448ESE_Ly0ELb0EEEE1_ENSU_INSV_ILy4590200209379688448ESE_Ly0ELb1EEEE1_EEEEEEEvDpOT_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i64)
