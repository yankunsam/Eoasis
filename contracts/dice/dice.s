...
_ZN4dice12claimexpiredEy:
	...
	i32.const	$push132=, 0
	i32.const	$push129=, 0
	i32.load	$push130=, __stack_pointer($pop129)
	i32.const	$push131=, 48
	i32.sub 	$push149=, $pop130, $pop131
	tee_local	$push148=, $10=, $pop149
	i32.store	__stack_pointer($pop132), $pop148
	block   	
	i32.const	$push2=, 84
	i32.add 	$push3=, $0, $pop2
	i32.load	$push147=, 0($pop3)
	tee_local	$push146=, $9=, $pop147
	i32.const	$push0=, 80
	i32.add 	$push1=, $0, $pop0
	i32.load	$push145=, 0($pop1)
	tee_local	$push144=, $2=, $pop145
	i32.eq  	$push4=, $pop146, $pop144
	br_if   	0, $pop4
...
.LBB12_2:
	...
	i32.add 	$push153=, $8, $pop154
	tee_local	$push152=, $4=, $pop153
	copy_local	$8=, $pop152
	i32.add 	$push9=, $4, $3
	i32.const	$push151=, -24
	i32.ne  	$push10=, $pop9, $pop151
	br_if   	0, $pop10
.LBB12_4:
	end_loop
	end_block
	...
	i32.load	$push157=, 0($pop13)
	tee_local	$push156=, $8=, $pop157
	i32.load	$push14=, 160($pop156)
...
.LBB12_6:
	...
	i32.call	$push160=, db_find_i64@FUNCTION, $pop22, $pop19, $pop23, $1
	tee_local	$push159=, $9=, $pop160
	i32.const	$push158=, 0
	i32.lt_s	$push24=, $pop159, $pop158
	br_if   	0, $pop24
	i32.call	$push162=, _ZNK5eosio11multi_indexILy7035924439720001536EN4dice4gameEJEE31load_object_by_primary_iteratorEl@FUNCTION, $4, $9
	tee_local	$push161=, $8=, $pop162
	i32.load	$push25=, 160($pop161)
...
.LBB12_8:
	...
	i32.gt_u	$4=, $pop37, $pop34
.LBB12_10:
	end_block
	i32.const	$push38=, .L.str.47
	call    	eosio_assert@FUNCTION, $4, $pop38
	i32.const	$push39=, 16
	i32.add 	$push40=, $0, $pop39
	i32.store	32($10), $pop40
	i32.const	$push174=, 56
	i32.add 	$push41=, $8, $pop174
	i64.load	$1=, 0($pop41)
	i32.const	$push173=, 48
	i32.add 	$push42=, $8, $pop173
	i64.load	$5=, 0($pop42)
	i32.const	$push172=, 40
	i32.add 	$push43=, $8, $pop172
	i64.load	$6=, 0($pop43)
	i64.load	$7=, 32($8)
	i32.const	$push171=, 1
	i32.const	$push170=, .L.str.15
	call    	eosio_assert@FUNCTION, $pop171, $pop170
	i64.store	8($10), $7
	i64.store	0($10), $6
	i32.const	$push169=, 1
	i32.const	$push168=, .L.str.15
	call    	eosio_assert@FUNCTION, $pop169, $pop168
	i32.const	$push44=, 24
	i32.add 	$push167=, $10, $pop44
	tee_local	$push166=, $3=, $pop167
	i64.store	0($pop166), $5
	i64.store	16($10), $1
	i32.const	$push136=, 40
	i32.add 	$push137=, $10, $pop136
	i32.const	$push138=, 32
	i32.add 	$push139=, $10, $pop138
	call    	_ZNK5eosio11multi_indexILy11733754445404569600EN4dice5offerEJNS_10indexed_byILy4229443000054317056EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_6by_betEvEEEEEENS3_ILy4982431883047354368ENS6_IS2_NS_9fixed_keyILj32EEEXadL_ZNKS2_13by_commitmentEvEEEEEEEE5indexILy4982431883047354368ESB_Ly1ELb0EE11lower_boundERKSA_@FUNCTION, $pop137, $pop139, $10
	block   	
	i32.load	$push165=, 44($10)
	tee_local	$push164=, $4=, $pop165
	i32.eqz 	$push200=, $pop164
	br_if   	0, $pop200
	i32.const	$push182=, 56
	i32.add 	$push45=, $4, $pop182
	i64.load	$6=, 0($pop45)
	i32.const	$push181=, 48
	i32.add 	$push46=, $4, $pop181
	i64.load	$7=, 0($pop46)
	i32.const	$push180=, 40
	i32.add 	$push47=, $4, $pop180
	i64.load	$1=, 0($pop47)
	i64.load	$5=, 32($4)
	i32.const	$push179=, 1
	i32.const	$push178=, .L.str.15
	call    	eosio_assert@FUNCTION, $pop179, $pop178
	i32.const	$push177=, 1
	i32.const	$push176=, .L.str.15
	call    	eosio_assert@FUNCTION, $pop177, $pop176
	i64.load	$push50=, 0($10)
	i64.xor 	$push51=, $1, $pop50
	i64.load	$push48=, 8($10)
	i64.xor 	$push49=, $5, $pop48
	i64.or  	$push52=, $pop51, $pop49
	i64.const	$push175=, 0
	i64.ne  	$push53=, $pop52, $pop175
	br_if   	0, $pop53
	i32.const	$push58=, 16
	i32.add 	$push59=, $10, $pop58
	i64.load	$push60=, 0($pop59)
	i64.xor 	$push61=, $pop60, $6
	i32.const	$push54=, 24
	i32.add 	$push55=, $10, $pop54
	i64.load	$push56=, 0($pop55)
	i64.xor 	$push57=, $pop56, $7
	i64.or  	$push62=, $pop61, $pop57
	i64.const	$push183=, 0
	i64.ne  	$push63=, $pop62, $pop183
	br_if   	0, $pop63
	i32.load	$9=, 44($10)
.LBB12_14:
	end_block
	...
	i32.add 	$push67=, $8, $pop66
	i64.load	$5=, 0($pop67)
	i32.const	$push68=, 104
	i32.add 	$push69=, $8, $pop68
	i64.load	$6=, 0($pop69)
	i64.load	$7=, 96($8)
	i32.const	$push189=, 1
	i32.const	$push188=, .L.str.15
	call    	eosio_assert@FUNCTION, $pop189, $pop188
	i64.store	8($10), $7
	i64.store	0($10), $6
	i32.const	$push187=, 1
	i32.const	$push186=, .L.str.15
	call    	eosio_assert@FUNCTION, $pop187, $pop186
	i64.store	0($3), $5
	i64.store	16($10), $1
	i32.const	$push140=, 40
	i32.add 	$push141=, $10, $pop140
	i32.const	$push142=, 32
	i32.add 	$push143=, $10, $pop142
	call    	_ZNK5eosio11multi_indexILy11733754445404569600EN4dice5offerEJNS_10indexed_byILy4229443000054317056EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_6by_betEvEEEEEENS3_ILy4982431883047354368ENS6_IS2_NS_9fixed_keyILj32EEEXadL_ZNKS2_13by_commitmentEvEEEEEEEE5indexILy4982431883047354368ESB_Ly1ELb0EE11lower_boundERKSA_@FUNCTION, $pop141, $pop143, $10
	i32.const	$3=, 0
	block   	
	i32.load	$push185=, 44($10)
	tee_local	$push184=, $4=, $pop185
	i32.eqz 	$push201=, $pop184
	br_if   	0, $pop201
	i32.const	$push70=, 56
	...
	call    	eosio_assert@FUNCTION, $pop77, $pop76
	i32.const	$push192=, 1
	i32.const	$push191=, .L.str.15
	call    	eosio_assert@FUNCTION, $pop192, $pop191
	i64.load	$push80=, 0($10)
	i64.xor 	$push81=, $1, $pop80
	i64.load	$push78=, 8($10)
	i64.xor 	$push79=, $5, $pop78
	i64.or  	$push82=, $pop81, $pop79
	i64.const	$push190=, 0
	i64.ne  	$push83=, $pop82, $pop190
	br_if   	0, $pop83
	i32.const	$push88=, 16
	i32.add 	$push89=, $10, $pop88
	i64.load	$push90=, 0($pop89)
	i64.xor 	$push91=, $pop90, $6
	i32.const	$push84=, 24
	i32.add 	$push85=, $10, $pop84
	i64.load	$push86=, 0($pop85)
	i64.xor 	$push87=, $pop86, $7
	i64.or  	$push92=, $pop91, $pop87
	i64.const	$push193=, 0
	i64.ne  	$push93=, $pop92, $pop193
	br_if   	0, $pop93
	i32.load	$3=, 44($10)
.LBB12_18:
	end_block
...
.LBB12_22:
	...
	i64.const	$push196=, 0
	i64.ne  	$push114=, $pop113, $pop196
	br_if   	0, $pop114
	i32.const	$push115=, 136
	i32.add 	$push116=, $8, $pop115
	i64.load	$push117=, 0($pop116)
	i64.const	$push197=, 0
	i64.ne  	$push118=, $pop117, $pop197
	br_if   	0, $pop118
	i32.const	$push119=, 144
	i32.add 	$push120=, $8, $pop119
	i64.load	$push121=, 0($pop120)
	i64.const	$push198=, 0
	i64.ne  	$push122=, $pop121, $pop198
	br_if   	0, $pop122
...
.LBB12_26:
	end_block
	i32.const	$push126=, .L.str.48
	call    	eosio_assert@FUNCTION, $4, $pop126
	call    	_ZN4dice13pay_and_cleanERKNS_4gameERKNS_5offerES5_@FUNCTION, $0, $8, $9, $3
	br      	1
.LBB12_27:
	end_block
	i32.const	$push128=, 1
	i32.const	$push127=, .L.str.48
	call    	eosio_assert@FUNCTION, $pop128, $pop127
...
.LBB12_28:
	...
	i32.store	__stack_pointer($pop135), $pop134
	.endfunc
.Lfunc_end12:
...
.LBB78_9:
	...
	.endfunc
.Lfunc_end78:
	.size	strlen, .Lfunc_end78-strlen
