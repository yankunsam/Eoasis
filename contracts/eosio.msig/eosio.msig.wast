(module
 ...
 (data (i32.const 32) "now=\00")
 (data (i32.const 48) " exp=\00")
 (data (i32.const 64) "\n\00")
 (data (i32.const 80) "read\00")
 (data (i32.const 96) "transaction expired\00")
 (data (i32.const 128) "object passed to iterator_to is not in multi_index\00")
 (data (i32.const 192) "proposal with the same name exists\00")
 (data (i32.const 240) "transaction authorization failed\00")
 ...
 (data (i32.const 400) "proposal not found\00")
 (data (i32.const 432) "approval is not on the list of requested approvals\00")
 ...
 (data (i32.const 720) "no approval previously granted\00")
 (data (i32.const 752) "cannot cancel until expiration\00")
